...
#define RME_PGT_RAW_ENABLE                              (1U)
/* Modifiable ****************************************************************/
/* Kernel object virtual memory base */
#define RME_KOM_VA_BASE                                 (0x20001500U)
/* Kernel object virtual memory size */
#define RME_KOM_VA_SIZE                                 (0x1280U)
...
#define RME_KSTK_VA_BASE                                (0x200027A0U)
...
#define RME_RVM_INIT_CPT_SIZE                           (48U)
/* Initial kernel object frontier limit */
#define RME_RVM_CPT_BOOT_FRONT                          (7U)
#define RME_RVM_KOM_BOOT_FRONT                          (0x6F0U)
/* Post-boot kernel object frontier limit */
#define RME_RVM_CPT_DONE_FRONT                          (16U)
#define RME_RVM_KOM_DONE_FRONT                          (0x1280U)

/* Init process's first thread's entry point address */
#define RME_RV32P_INIT_ENTRY                            (0x8000U)
/* Init process's first thread's stack address */
#define RME_RV32P_INIT_STACK                            (0x20006FF0U)
