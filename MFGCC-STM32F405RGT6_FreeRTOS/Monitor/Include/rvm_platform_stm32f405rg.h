...
#define RVM_KOM_VA_BASE                                 (0x10001280U)
/* Kernel object virtual memory size */
#define RVM_KOM_VA_SIZE                                 (0x1500U)
...
#define RVM_KOM_DONE_FRONT                              (0x1500U)
...
#define RVM_SFTD_STACK_BASE                             (0x10006000U)
#define RVM_SFTD_STACK_SIZE                             (0x800U)
#define RVM_VMMD_STACK_BASE                             (0x10005800U)
