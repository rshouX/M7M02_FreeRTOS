...
#define RVM_PGT_VIRT1_4                                 (RVM_CID(RVM_MAIN_PGT_0, 13U))
#define RVM_PGT_VIRT1_5                                 (RVM_CID(RVM_MAIN_PGT_0, 14U))
...
#define RVM_BOOT_INIT_PGT_AFTER                         (0x1070U)
#define RVM_BOOT_INIT_PGT_MAIN_NUM                      (1U)
#define RVM_BOOT_INIT_PGT_CRT_NUM                       (15U)
#define RVM_BOOT_INIT_PGT_CON_NUM                       (12U)
#define RVM_BOOT_INIT_PGT_ADD_NUM                       (21U)

/* Process frontiers & number */
#define RVM_BOOT_PRC_BEFORE                             (0x1070U)
#define RVM_BOOT_PRC_AFTER                              (0x10D0U)
