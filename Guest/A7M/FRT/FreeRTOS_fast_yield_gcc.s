...
/* Export ********************************************************************/
    ...
    .global             _FreeRTOS_A7M_RVM_Yield
/* End Export ****************************************************************/
...
/* Function:_FreeRTOS_A7M_RVM_Yield *******************************************
...
Stk_Basic_Done:       
    ...
    LDR                 R1,=pxCurrentTCB    /* Save the SP to control block */
    LDR                 R1,[R1]
    STR                 SP,[R1]
    BL                  vTaskSwitchContext  /* Get the highest ready task */
    LDR                 R1,=pxCurrentTCB    /* Load the SP */
    LDR                 R1,[R1]
    LDR                 SP,[R1]
...
_RMP_A7M_Skip:
    BX                  LR
/* End Function:_FreeRTOS_A7M_RVM_Yield **************************************/
    .end
/* End Of File ***************************************************************/
