...
#define RVM_PGT_PROC2_0                                 (RVM_CID(RVM_MAIN_PGT_0, 3U))
#define RVM_PGT_PROC2_1                                 (RVM_CID(RVM_MAIN_PGT_0, 4U))
#define RVM_PGT_PROC2_2                                 (RVM_CID(RVM_MAIN_PGT_0, 5U))
#define RVM_PGT_PROC2_3                                 (RVM_CID(RVM_MAIN_PGT_0, 6U))
#define RVM_PGT_PROC2_4                                 (RVM_CID(RVM_MAIN_PGT_0, 7U))
...
#define RVM_BOOT_VEP_BEFORE                             (0x800U)
#define RVM_BOOT_VEP_AFTER                              (0x820U)
#define RVM_BOOT_VEP_MAIN_NUM                           (1U)
#define RVM_BOOT_VEP_CRT_NUM                            (1U)
#define RVM_BOOT_VCAP_INIT_NUM                          (1U)

/* Cpt frontiers & number */
#define RVM_BOOT_INIT_CPT_BEFORE                        (0x820U)
#define RVM_BOOT_INIT_CPT_AFTER                         (0xA20U)
...
#define RVM_BOOT_INIT_PGT_BEFORE                        (0xA20U)
#define RVM_BOOT_INIT_PGT_AFTER                         (0xE00U)
#define RVM_BOOT_INIT_PGT_MAIN_NUM                      (1U)
#define RVM_BOOT_INIT_PGT_CRT_NUM                       (11U)
#define RVM_BOOT_INIT_PGT_CON_NUM                       (8U)
#define RVM_BOOT_INIT_PGT_ADD_NUM                       (16U)

/* Process frontiers & number */
#define RVM_BOOT_PRC_BEFORE                             (0xE00U)
#define RVM_BOOT_PRC_AFTER                              (0xE60U)
#define RVM_BOOT_PRC_MAIN_NUM                           (1U)
#define RVM_BOOT_PRC_CRT_NUM                            (3U)

/* Thread frontiers & number */
#define RVM_BOOT_THD_BEFORE                             (0xE60U)
#define RVM_BOOT_THD_AFTER                              (0x10C0U)
#define RVM_BOOT_THD_MAIN_NUM                           (1U)
#define RVM_BOOT_THD_CRT_NUM                            (4U)
#define RVM_BOOT_THD_INIT_NUM                           (4U)

/* Invocation frontiers & number */
#define RVM_BOOT_INV_BEFORE                             (0x10C0U)
#define RVM_BOOT_INV_AFTER                              (0x1140U)
...
#define RVM_BOOT_RCV_BEFORE                             (0x1140U)
#define RVM_BOOT_RCV_AFTER                              (0x1180U)
