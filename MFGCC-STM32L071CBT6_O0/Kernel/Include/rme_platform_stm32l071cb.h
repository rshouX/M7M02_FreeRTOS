...
#define RME_KSTK_VA_BASE                                (0x200013C0U)
...
#define RME_RVM_PHYS_VCT_NUM                            (30U)
#define RME_RVM_PHYS_VCTF_BASE                          (0x200017E0U)
#define RME_RVM_PHYS_VCTF_SIZE                          (0x20U)
/* Virtual event number, flag area base and size */
#define RME_RVM_VIRT_EVT_NUM                            (32U)
#define RME_RVM_VIRT_EVTF_BASE                          (0x200017C0U)
#define RME_RVM_VIRT_EVTF_SIZE                          (0x20U)
/* Size of initial capability table */
#define RME_RVM_INIT_CPT_SIZE                           (49U)
/* Initial kernel object frontier limit */
#define RME_RVM_CPT_BOOT_FRONT                          (7U)
#define RME_RVM_KOM_BOOT_FRONT                          (0x700U)
/* Post-boot kernel object frontier limit */
#define RME_RVM_CPT_DONE_FRONT                          (17U)
#define RME_RVM_KOM_DONE_FRONT                          (0x1180U)

/* Init process's first thread's entry point address */
#define RME_A6M_INIT_ENTRY                              (0x800E001U)
/* Init process's first thread's stack address */
#define RME_A6M_INIT_STACK                              (0x200027F0U)
/* What is the Systick value? - 10ms per tick */
#define RME_A6M_SYSTICK_VAL                             (320000)
