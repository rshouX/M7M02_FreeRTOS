...
#define RVM_BOOT_VEP_BEFORE                             (0x8D0U)
#define RVM_BOOT_VEP_AFTER                              (0x8F0U)
#define RVM_BOOT_VEP_MAIN_NUM                           (1U)
#define RVM_BOOT_VEP_CRT_NUM                            (1U)
#define RVM_BOOT_VCAP_INIT_NUM                          (1U)

/* Cpt frontiers & number */
#define RVM_BOOT_INIT_CPT_BEFORE                        (0x8F0U)
#define RVM_BOOT_INIT_CPT_AFTER                         (0xC10U)
...
#define RVM_BOOT_RCV_BEFORE                             (0x1240U)
#define RVM_BOOT_RCV_AFTER                              (0x1280U)
