...
#define RVM_BOOT_RCV_BEFORE                             (0x1070U)
#define RVM_BOOT_RCV_AFTER                              (0x10F0U)
#define RVM_BOOT_RCV_MAIN_NUM                           (1U)
#define RVM_BOOT_RCV_CRT_NUM                            (4U)

/* Code memory blocks */
#define RVM_PROC1_CODE_CODE1_BASE                       (0x8030000U)
#define RVM_PROC1_CODE_CODE1_SIZE                       (0x8000U)
#define RVM_PROC2_CODE_CODE1_BASE                       (0x8038000U)
#define RVM_PROC2_CODE_CODE1_SIZE                       (0x8000U)
#define RVM_VIRT1_CODE_CODE1_BASE                       (0x8020000U)
#define RVM_VIRT1_CODE_CODE1_SIZE                       (0x10000U)

/* Data memory blocks */
#define RVM_PROC1_DATA_DATA1_BASE                       (0x20010000U)
#define RVM_PROC1_DATA_DATA1_SIZE                       (0x8000U)
#define RVM_PROC2_DATA_DATA1_BASE                       (0x20018000U)
#define RVM_PROC2_DATA_DATA1_SIZE                       (0x4000U)
#define RVM_VIRT1_DATA_DATA1_BASE                       (0x20000000U)
#define RVM_VIRT1_DATA_DATA1_SIZE                       (0x10000U)
#define RVM_DATA_SHARED_SHARED1_BASE                    (0x10007000U)
