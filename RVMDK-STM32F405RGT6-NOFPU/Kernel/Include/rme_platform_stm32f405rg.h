...
#define RME_KOM_VA_BASE                                 (0x10001680U)
/* Kernel object virtual memory size */
#define RME_KOM_VA_SIZE                                 (0x1100U)
...
#define RME_KSTK_VA_BASE                                (0x100027A0U)
...
#define RME_RVM_KOM_DONE_FRONT                          (0x10F0U)

/* Init process's first thread's entry point address */
#define RME_A7M_INIT_ENTRY                              (0x8010001U)
/* Init process's first thread's stack address */
#define RME_A7M_INIT_STACK                              (0x10006FF0U)
