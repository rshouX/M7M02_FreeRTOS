...
#define RME_PROC1_CODE_CODE1_SIZE                       (0x8000U)
#define RME_PROC2_CODE_CODE1_BASE                       (0x8038000U)
#define RME_PROC2_CODE_CODE1_SIZE                       (0x8000U)
#define RME_VIRT1_CODE_CODE1_BASE                       (0x8020000U)
#define RME_VIRT1_CODE_CODE1_SIZE                       (0x10000U)

/* Data memory blocks */
#define RME_PROC1_DATA_DATA1_BASE                       (0x20010000U)
#define RME_PROC1_DATA_DATA1_SIZE                       (0x8000U)
#define RME_PROC2_DATA_DATA1_BASE                       (0x20018000U)
#define RME_PROC2_DATA_DATA1_SIZE                       (0x4000U)
#define RME_VIRT1_DATA_DATA1_BASE                       (0x20000000U)
#define RME_VIRT1_DATA_DATA1_SIZE                       (0x10000U)
#define RME_DATA_SHARED_SHARED1_BASE                    (0x10007000U)
