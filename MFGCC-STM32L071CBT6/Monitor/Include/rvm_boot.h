...
/* Vector endpoints */
#define RVM_VCT_TIM21                                   (RVM_CID(RVM_MAIN_VCT_0, 0U))
...
#define RVM_PGT_PROC1_4                                 (RVM_CID(RVM_MAIN_PGT_0, 4U))
#define RVM_PGT_PROC2_0                                 (RVM_CID(RVM_MAIN_PGT_0, 5U))
#define RVM_PGT_PROC2_1                                 (RVM_CID(RVM_MAIN_PGT_0, 6U))
#define RVM_PGT_PROC2_2                                 (RVM_CID(RVM_MAIN_PGT_0, 7U))
#define RVM_PGT_PROC2_3                                 (RVM_CID(RVM_MAIN_PGT_0, 8U))
#define RVM_PGT_VIRT1_0                                 (RVM_CID(RVM_MAIN_PGT_0, 9U))
#define RVM_PGT_VIRT1_1                                 (RVM_CID(RVM_MAIN_PGT_0, 10U))
#define RVM_PGT_VIRT1_2                                 (RVM_CID(RVM_MAIN_PGT_0, 11U))
#define RVM_PGT_VIRT1_3                                 (RVM_CID(RVM_MAIN_PGT_0, 12U))
...
/* Code memory blocks */
#define RVM_PROC1_CODE_CODE1_BASE                       (0x8016000U)
#define RVM_PROC1_CODE_CODE1_SIZE                       (0x1000U)
#define RVM_PROC2_CODE_CODE1_BASE                       (0x8017000U)
#define RVM_PROC2_CODE_CODE1_SIZE                       (0x1000U)
#define RVM_VIRT1_CODE_CODE1_BASE                       (0x8018000U)
#define RVM_VIRT1_CODE_CODE1_SIZE                       (0x8000U)

/* Data memory blocks */
#define RVM_PROC1_DATA_DATA1_BASE                       (0x20002800U)
#define RVM_PROC1_DATA_DATA1_SIZE                       (0x800U)
#define RVM_PROC2_DATA_DATA1_BASE                       (0x20004000U)
#define RVM_PROC2_DATA_DATA1_SIZE                       (0x800U)
#define RVM_VIRT1_DATA_DATA1_BASE                       (0x20003000U)
#define RVM_VIRT1_DATA_DATA1_SIZE                       (0x1000U)
#define RVM_DATA_SHARED_SHARED1_BASE                    (0x20004800U)
#define RVM_DATA_SHARED_SHARED1_SIZE                    (0x100U)
