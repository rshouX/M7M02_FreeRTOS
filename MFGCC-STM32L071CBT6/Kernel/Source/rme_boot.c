...
/* Private Variable **********************************************************/
static struct RME_Cap_Sig* Tim21_Vct_Sig;
/* End Private Variable ******************************************************/

/* Private Function **********************************************************/
RME_EXTERN rme_ptr_t RME_Vct_Tim21_Handler(struct RME_Reg_Struct* Reg);
                            ...
                            rme_ptr_t Kom_Front)
{
    ...
    RME_ASSERT(Kom_Front==0x20000620U);
    ...
    Tim21_Vct_Sig=&(RME_CAP_GETOBJ(Sig_Cpt,struct RME_Cap_Sig*)[RVM_VCT_TIM21]);
    RME_ASSERT(_RME_Sig_Boot_Crt(Cpt, RME_MAIN_VCT_0, RVM_VCT_TIM21)==0U);
                               ...
                               rme_ptr_t Vct_Num)
{
    ...
    switch(Vct_Num)
    {
        ...
        case 20U: 
        {
            Send=RME_Vct_Tim21_Handler(Reg);
            Endp=Tim21_Vct_Sig;
            break;
        }
        /* Spurious */
