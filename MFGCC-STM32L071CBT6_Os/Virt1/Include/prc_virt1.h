...
/* Code memory blocks */
#define CODE_V_CODE_BASE                                (0x8016000U)
#define CODE_V_CODE_SIZE                                (0x8000U)

/* Data memory blocks */
#define DATA_V_DATA_BASE                                (0x20002800U)
#define DATA_V_DATA_SIZE                                (0x1000U)
...
#define RVM_VIRT_STATE_BASE                             (0x200033C0U)
#define RVM_VIRT_STATE_SIZE                             (0x40U)
/* Virtual register base address & size */
#define RVM_VIRT_REG_BASE                               (0x20003390U)
