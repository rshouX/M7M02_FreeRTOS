...
#define RME_KOM_VA_BASE                                 (0x20001800U)
/* Kernel object virtual memory size */
#define RME_KOM_VA_SIZE                                 (0xF80U)
